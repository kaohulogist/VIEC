...
//switch case statment
  ...
  switch(decimalNumber){
    case 1:
    Serial.println("Running Accerlerometer Application");
    break;
  
    case 2:
    Serial.println("Running Barometer Application");
    break;

    case 3:
    Serial.println("Running Ultrasonic Application");
    break;

    case 4:
    Serial.println("Running Switch Application");
    break;
  }
