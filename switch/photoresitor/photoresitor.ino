...
void setup()
{
  ...
  initialBrightness = analogRead(photoResistorPin);
...
void loop()
{
  ...
  currentBrightness = analogRead(photoResistorPin);
  Serial.print("Initial Brightness: ");
  Serial.print(initialBrightness);
  Serial.println("");
  ...
  if (currentBrightness < initialBrightness - 50)
  {
    digitalWrite(9, HIGH);
  }
